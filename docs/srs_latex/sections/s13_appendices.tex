...
Valor inválido $\rightarrow$ alerta HLC; voltaje de cualquier banco $<$12.8\,V $\rightarrow$ SafeMode (SYS-FUN-040a) &
EPS-REQ-001 \newline SYS-FUN-040a \\ \hline

BTS7960 \newline (drivers motores $\times$6) &
...
Este apéndice establece los presupuestos de ingeniería (potencia, masa y enlace RF) del Rover Olympus con valores derivados de hojas de datos del fabricante (\textbf{[DS]}), estimaciones de ingeniería (\textbf{[EST]}), mediciones en hardware real (\textbf{[MED]}) y parámetros pendientes de medición (\textbf{[TBM]}). Los valores [TBM] deben resolverse antes del cierre de la campaña V\&V para cerrar los requisitos RNF-007 (MOD $\ge$2\,h) y EPS-REQ-001 (monitoreo multi-banco INA3221) \cite{rpi5_brief, arduino_mega_ds}.

% ------------------------------------------------------------
\subsubsection{Power Budget (Bus 12 V — 3 bancos LiPo 4S)}
% ------------------------------------------------------------
...
\caption{Presupuesto de potencia del Rover Olympus (modo traversal, bus 12\,V, 3 bancos LiPo 4S).
...
EPS    & LiPo 4S + BMS Daly ($\times$3 bancos) & {[TBM]} & [TBM] & celdas + portabaterías + BMS \\ \hline
\hline
\multicolumn{2}{|l|}{\textbf{Electrónica conocida (excl. estructura)}} & $\approx$2\,386 & [DS/EST] & sin arnés ni batería \\ \hline
\multicolumn{2}{|l|}{\textbf{Total medido (sistema completo)}}       & $\approx$9\,300 & [MED] & balanza, configuración de campaña (PHY-002 $\le$10\,kg: cumple) \\ \hline
\end{tabularx}
