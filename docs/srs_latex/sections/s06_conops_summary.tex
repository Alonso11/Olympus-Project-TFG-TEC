...
\begin{itemize}
  ...
  \item \textbf{SafeMode} (\texttt{Safe}): modo de preservación (safing); prioriza seguridad del sistema, minimiza actividad no esencial y favorece diagnósticos y comunicación mínima. Activado por anomalía de batería (LLC \texttt{batt\_mv < 12\,V}), temperatura ambiente $>$ \texttt{AMBIENT\_SAFE\_C}, EMC u otro fallo recuperable. \cite{SafeModeContext1,UMLStateMachinesConcepts2}
