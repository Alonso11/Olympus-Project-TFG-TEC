...
Este SyRS adota la estructura de un SRS/SyRS conforme a ISO/IEC/IEEE 29148:2018 y se alinea con prácticas NASA de ingeniería de sistemas para proyectos de exploración robótica, aplicando ``tailoring'' apropiado al contexto académico (plataforma COTS, validación en sitio análogo, foco UC‑01). \cite{ieee_29148, nasa_se_handbook} 
