...
% TODO: regenerar la figura maquina_lista.drawio.png para reflejar los 7 estados RoverState + dimensión SafetyState. La versión actual del diagrama muestra solo 5 estados (Standby, Exploración activa, HomingRetreat, SafeMode, Final).
