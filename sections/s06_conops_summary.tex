...
\begin{enumerate}
    ...
    \item \textbf{Ejecución autónoma (ELANav):} El rover ejecuta navigation autónoma local (percepción, clasificación de transitabilidad, evitación, compensación de slip) y gestiona contingencias (fault stop, retorno a comunicación).
    ...
    \item \textbf{Hibernación / Idle:} El rover entra en un modo de bajo consumo o reposo operativo entre ventanas de actividad o condiciones del sitio.
\end{enumerate}
...
\begin{enumerate}
    \item \textbf{Geometría y mecánica del terreno:} Pendientes de hasta 20° y transiciones de suelo con obstáculos;estas condiciones pueden inducir slip y atascos (ver caracterización del entorno en §\ref{subsec:operational_environment}).
