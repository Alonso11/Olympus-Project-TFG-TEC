...
\centering
\small
\begin{tabularx}{\textwidth}{| l | c | X | p{4.0cm} |}
\hline
...
\end{tabularx}
\caption{Clasificación de criticidad de software del Rover Olympus (NASA-STD-8739.8B, simplificado).}
