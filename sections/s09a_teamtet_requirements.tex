...
\begin{reqblock}
  \item \ReqID{SyRS-081}
  \item \ReqShall{El sistema deberá implementar mecanismos de protección eléctrica distribuida ante condiciones anómalas: NTC por celda 18650 NMC, voltaje multi-banco (INA3221), corriente por motor (ACS712), fusibles 10\,A por banco y aislamiento por relés conmutados (LLC D40/D41).}
  \item \ReqMetric{Presencia y verificación funcional de las protecciones distribuidas; ausencia de BMS dedicado por celda en la configuración actual (ver nota EPS en \S\ref{subsec:internal_interfaces}).}
