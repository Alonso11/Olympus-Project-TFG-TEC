...
\begin{reqblock}
  ...
  \item \ReqMetric{Transiciones disparadas por al menos: cmd\_\allowbreak start\_\allowbreak exploration, cmd\_\allowbreak pause\_\allowbreak exploration, cmd\_\allowbreak homing\_\allowbreak retreat, sw\_\allowbreak fault\_\allowbreak critical, power\_\allowbreak anomaly\_\allowbreak detected, cmd\_\allowbreak end\_\allowbreak mission.}
...
\begin{reqblock}
  ...
  \item \ReqCond{UC-01; evento conditions\_\allowbreak adverse\_\allowbreak detected con guarda severity\_\allowbreak allows\_\allowbreak retreat (TBD si no está cuantificada).}
...
\begin{reqblock}
  ...
  \item \ReqMetric{Presencia de mecanismos de protección definidos en EPS (BMS/\allowbreak protecciones/\allowbreak distribución) y verificación funcional según procedimiento.}
  \item \ReqCond{Integración del subsistema EPS.}
  \item \ReqAccept{Inspección física + verificación funcional de disparo/\allowbreak aislamiento conforme a procedimiento de prueba.}
  \item \ReqTrace{Arquitectura EPS/\allowbreak N2: §8.2.1.7 y Cuadro N2 (potencia/\allowbreak protecciones).}
\end{reqblock}
\end{sloppypar}
