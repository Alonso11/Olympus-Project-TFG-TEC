...
\begin{reqblock}
  ...
  \item \ReqMetric{Presencia de mecanismos de protección definidos en EPS
    (BMS/\allowbreak protecciones/\allowbreak distribución)
    y verificación funcional según procedimiento.}
