...
MODE-001..006 & Modos STB/\allowbreak EXP/\allowbreak AVD/\allowbreak RET/\allowbreak FLT/\allowbreak SAFE & §9.4 Tab.~\ref{tab:op_modes} & Demonstration & S & OPEN \\ \hline
...
TBD-OP-01 & Umbrales de severidad para contingencias (\texttt{severity\_\allowbreak allows\_\allowbreak retreat}) & §7.3.8 (SM), s09a & Líder GNC & Análisis de simulación en entorno volcánico. \\ \hline
...
\begin{itemize}
    ...
    \item \textbf{V\&V:} Verification \& Validation, con métodos T/A/D/I (Test/\allowbreak Analysis/\allowbreak Demonstration/\allowbreak Inspection). \cite{omg_sysml_mbse, nasa_cm, segoldmine_ppi}
